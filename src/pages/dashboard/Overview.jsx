...
import { CalendarCheck, Clock, Heart, Star, MapPin, BookOpen, LogIn, Timer, X, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <>
      <section className="dash__hero">
        ...
        <div className="dash__hero-copy">
          <h2>أهلاً {user.name || 'بك'} بعودتك</h2>
          <p>
            {user.role === 'owner'
        ...
        <div className="dash__hero-ads">
          ...
          <div className="dash__hero-ads-nav">
            <button
              type="button"
              className="dash__hero-ad-arrow is-prev"
              onClick={() => setActiveAd((i) => (i - 1 + dashAds.length) % dashAds.length)}
            ...
            <button
              type="button"
              className="dash__hero-ad-arrow is-next"
              onClick={() => setActiveAd((i) => (i + 1) % dashAds.length)}
